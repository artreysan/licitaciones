...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      moveSelectedLabel: 'Mover los seleccionados',
      ...
      infoTextFiltered: '<span class="label label-warning">Filtrados</span> {0} de {1}', // when not all of the options are visible due to the filter
