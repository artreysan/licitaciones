    ...
    return function e(t, n, r) {
        ...
        2: [function(require, module, exports) {
            ...
            module.exports = function getEventProperty(prop, event) {
                return has.call(event, prop) ? event[prop] : event.originalEvent && event.originalEvent.touches ? event.originalEvent.touches[0][prop] : undefined
            }
        }, {}],
        ...
        4: [function(require, module, exports) {
            ...
            var Mark = Element.extend({
                initialize: function initialize(options) {
                    initialize.super$.call('<div class="elessar-label">');
...
// alert();
                ...
                writeLabel: function(text) {
                  ...
                  if(horafi){
                    ...
                    var horafis = horafi.split(" ");
                    var horaffs = horaff.split(" ");



                    if (horafis[3][0]=="A") {
                      var horaffsn= horafis[2].split(":");

                        if (Math.trunc(horaffsn[0])==12) {
                      ...
                      var horaffsn= horafis[2].split(":");
                        ...
                        if (Math.trunc(horaffsn[0])!=12) {
                          horaffsn[0]=Math.trunc(horaffsn[0])+12;
                          horai = horaffsn[0]+":00";
                        }else {
                          horaffsn[0]=Math.trunc(horaffsn[0]);
                          horai = horaffsn[0]+":00";
                        }
                ...
                resizeEnd: function(origEv) {
                    ...
                    return function(ev) {
                        ...
                        if (typeof mousePos !== "undefined") {
                            ...
                            if (size >= minSize) {
                                self.val([self.range[0], self.range[0] + size / perantSize], {
                                    dontApplyDelta: true
                                })
                            } else if (size <= 10) {
                                self.swapping = true;
                ...
                resizeStart: function(origEv) {
                    ...
                    return function(ev) {
                        ...
                        if (typeof mousePos !== "undefined") {
                            ...
                            if (size >= minSize) {
                                self.val([start / perantSize, self.range[1]], {
                                    dontApplyDelta: true
                                })
                            } else if (size <= 10) {
                                self.swapping = true;
        ...
        8: [function(require, module, exports) {
            ...
            var RangeBar = Element.extend(vertical).extend({
                ...
                mousemove: function(ev) {
                    var w = this.options.minSize ? this.abnormaliseRaw(this.options.minSize + this.options.min) : .05;
            ...
            (function() {
                (function(definition) {
                    ...
                    return Base = function() {
                        ...
                        var attach, prototype = Base.prototype,
                            constructor = Base;
